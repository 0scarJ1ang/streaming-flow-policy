...
if __name__ == "__main__":
    ...
    # Mock calibration
    brain.static_obj_pos = np.array([0.5, 0.0, 0.1]) 
    ...
    try:
        while True:
            ...
            current_pose = np.array([0.4, 0.1, 0.3, 0, 0, 0, 1]) 
            ee_pose_queue.put(current_pose)
            
            action = brain.infer(ee_pose_queue, image_queue)
